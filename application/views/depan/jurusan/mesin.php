...
<section class="welcome_about">
    <div class="container">
        <div class="row">
            <div class="col-md-7">
                <h2>Alat Mesin Pertanian</h2>
                <p> Pada program keahlian alat mesin pertanian, siswa akan diajarkan bagaimana menggunakan atau mengoperasikan mesin-mesin yang digunakan pada proses pertanian, selain mengoperasikan mereka juga diajarkan cara memperbaiki mesin-mesin pertanian, mengetahui bagian-bagian yang ada pada mesin. Salah satu mesin yang dapat digunakan untuk mengolah hasil pertanian adalah mesin penggiling jagung, jagung yang awalnya berbentuk pipih dirubah menjadi bentuk butiran jagung yang siap untuk di konsumsi. </p>
