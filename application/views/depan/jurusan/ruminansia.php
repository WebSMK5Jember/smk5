...
<section class="welcome_about">
    <div class="container">
        <div class="row">
            <div class="col-md-7">
                <h2>Agribisnis Ternak Ruminansia</h2>
                <p> Pada program keahlian Agribisnis Ternak Ruminansia, siswa akan diajarkan bagaimana merawat ternak dengan baik dan benar. Mereka akan diajarkan bagaimana pengolahan makanan untuk hewan terrnak, cara memberi makan ternak, membersihakn tempat makan dan minum ternak, mengetahui penyakit-penyakit yag ada pada ternak. Selain itu mereka juga diajarkan bagaimana mengolah kotoran hewan hingga dapat digunakan menjadi pupuk. </p>
