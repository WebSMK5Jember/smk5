...
<section class="welcome_about">
    <div class="container">
        <div class="row">
            <div class="col-md-7">
                <h2>Agribisnis Tanaman Perkebunan</h2>
                <p> Pada program keahlian Agribisnis Tanaman Perkebunan, siswa akan dilatih untuk dapat memiliki keterampilan atau kompetensi dibidang tanaman perkebunan mulai dari kopi hingga kelapa sawit. Siswa akan diajarkan mulai dari tahap menanam, merawat hingga memanen hasil dari tanaman perkebunan.  </p>
