...
<li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Data Master Nilai Siswa
        <small></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Data Master Nilai Siswa</li>
      </ol>
    </section>
                  ...
                  <div class="form-group">
                             ...
                             <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="time" name="Semester" class="form-control" id="inputUserName" placeholder="Jam" required>
                                        </div>
                                    </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                            ...
                            <p>Apakah Anda yakin mau menghapus master nilai? <b><?php echo $nama;?></b> ?</p>
