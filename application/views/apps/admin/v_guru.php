...
<head>
  ...
  <title>SI Sekolah | Data Guru</title>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                              ...
                              <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="kode" class="form-control" id="inputUserName" placeholder="Kode Guru" required>
                                        </div>
                                    </div>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                          <select name="xmapel" class="form-control">
                                            <option value="">-Pilih-</option>
                                            <?php
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                          <select name="xpiket" class="form-control">
                                            <option value="">-Pilih-</option>
                                            <?php
