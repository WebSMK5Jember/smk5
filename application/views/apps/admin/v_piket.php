...
<head>
  ...
  <title>SI Sekolah | Data Master Piket Guru</title>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-success btn-flat" data-toggle="modal" data-target="#myModal"><span class="fa fa-plus"></span> Tambah Hari Piket</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                              ...
                              <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="kodepiket" class="form-control" id="inputUserName" placeholder="kodepiket" required>
                                        </div>
                                    </div>
...
<?php if($this->session->flashdata('msg')=='error'):?>
    ...
    <?php elseif($this->session->flashdata('msg')=='success'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Success',
                    text: "Master Piket Berhasil disimpan ke database.",
                    showHideTransition: 'slide',
                    icon: 'success',
                    hideAfter: false,
                    position: 'bottom-right',
    ...
    <?php elseif($this->session->flashdata('msg')=='info'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Info',
                    text: "Master Piket berhasil di update",
                    showHideTransition: 'slide',
                    icon: 'info',
                    hideAfter: false,
                    position: 'bottom-right',
    ...
    <?php elseif($this->session->flashdata('msg')=='success-hapus'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Success',
                    text: "Master Piket Berhasil dihapus.",
                    showHideTransition: 'slide',
                    icon: 'success',
                    hideAfter: false,
                    position: 'bottom-right',
