...
<html>
    <head>
        ...
        <!-- App favicon -->
        <link rel="shortcut icon" href="<?php echo base_url(); ?>layout/login/assets/images/logo_1.png">
                        ...
                        <div class="card-box p-5">
                            <h2 class="text-uppercase text-center pb-4">
                                <a href="index.html" class="text-success">
                                    <span><img src="<?php echo base_url(); ?>layout/login/assets/images/kaliber.png" alt="" height="170" width="170"></span>
                                </a>
                            </h2>

                            <form method="post" class="" action="<?php echo base_url('login_si/prosesLogin'); ?>">
