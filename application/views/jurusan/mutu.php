...
<head>
    ...
    <title>SMKN 5 Jember | Profil</title>
    ...
    <![endif]-->
    <link rel="shortcut icon" href="<?php echo base_url(); ?>layout/assets/images/ico/favicon.ico">
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <div class="about-content">
                        <h2>PENGAWASAN MUTU HASIL PERTANIAN DAN PERIKANAN</h2>
