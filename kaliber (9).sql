...
--
-- Host: 127.0.0.1
-- Generation Time: 31 Jan 2019 pada 22.29
...
--
-- Struktur dari tabel `tabel_laporguru_fix`
--

CREATE TABLE `tabel_laporguru_fix` (
  `KODE_LAPORGURU_FIX` int(5) NOT NULL,
  `KODE_LAPORGURU` varchar(5) NOT NULL,
  `ISI_LAPORGURU` varchar(300) NOT NULL,
  `TANGGAL_LAPORGURU` date NOT NULL,
  `KODE_GURU` varchar(5) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Struktur dari tabel `tabel_laporsarana_fix`
--

CREATE TABLE `tabel_laporsarana_fix` (
  `KODE_LAPORSARANA_FIX` int(5) NOT NULL,
  `KODE_LAPORSRANA` int(5) NOT NULL,
  `NIS` varchar(10) NOT NULL,
  `ISI_LAPORAN` varchar(300) NOT NULL,
  `TANGGAL_LAPORANSARANA` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Indexes for table `tabel_laporguru_fix`
--
ALTER TABLE `tabel_laporguru_fix`
  ADD PRIMARY KEY (`KODE_LAPORGURU_FIX`);
...
--
-- Indexes for table `tabel_laporsarana_fix`
--
ALTER TABLE `tabel_laporsarana_fix`
  ADD PRIMARY KEY (`KODE_LAPORSARANA_FIX`);
...
--
-- AUTO_INCREMENT for table `tabel_laporguru_fix`
--
ALTER TABLE `tabel_laporguru_fix`
  MODIFY `KODE_LAPORGURU_FIX` int(5) NOT NULL AUTO_INCREMENT;
--
...
--
-- AUTO_INCREMENT for table `tabel_laporsarana_fix`
--
ALTER TABLE `tabel_laporsarana_fix`
  MODIFY `KODE_LAPORSARANA_FIX` int(5) NOT NULL AUTO_INCREMENT;
--
