...
--
-- Host: 127.0.0.1
-- Generation Time: 29 Jan 2019 pada 08.47
...
('19591028 198103 2 004', NULL, 'A02', NULL, NULL, 'Titik Mujiwati, S.Pd', NULL, NULL, 24);
...
INSERT INTO `tabel_jadwal` (`KODE_KELAS`, `KODE_MAPEL`, `KODE_GURU`, `JAM`, `RUANG`, `HARI`) VALUES
('XKIA1', 'BDJW', 'A01', NULL, 'm', '0000-00-00');
...
('15045/0481', 'XKIA1', 'KIA', 'DINI AGUSTIANTI', 'JEMBER', '0000-00-00', NULL, NULL, 'Budi santoso', 'SMP', 'DN-05 DI/13 0108605');
...
INSERT INTO `table_daful` (`KODE_DAFUL`, `NIS`, `SEMESTER`, `TANGGAL_DAFUL`, `STATUS`) VALUES
(1, '15045/0481', 2, '2019-01-26 00:00:00', 'S'),
(2, '15045/0481', 2, '2019-01-25 00:00:00', 'S');
...
--
ALTER TABLE `table_daful`
  MODIFY `KODE_DAFUL` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
