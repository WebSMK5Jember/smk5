...
--
-- Host: 127.0.0.1
-- Generation Time: 01 Feb 2019 pada 07.54
...
--
-- Struktur dari tabel `tabel_guru1`
--

CREATE TABLE `tabel_guru1` (
  `NIP` varchar(30) NOT NULL,
  `KODE_MAPEL` varchar(5) DEFAULT NULL,
  `KODE_GURU` varchar(5) NOT NULL,
  `KODE_JABATAN` varchar(5) DEFAULT NULL,
...
('15045/0481', NULL, NULL, 'alvy', '', '0000-00-00', '', NULL, '', '', ''),
...
(14, 'cb9dd479331459d795dc47de60381bb0', 'a002', NULL, NULL, '5'),
(15, '3d397764da84b93bdbcd393999979218', NULL, '15045/0481', NULL, '4');
...
--
-- Indexes for table `tabel_guru1`
--
ALTER TABLE `tabel_guru1`
  ADD PRIMARY KEY (`KODE_GURU`),
  ADD KEY `FK_REFERENCE_24` (`KODE_JABATAN`),
  ADD KEY `FK_REFERENCE_25` (`KODE_PIKET`),
  ADD KEY `FK_REFERENCE_4` (`KODE_MAPEL`);
...
--
-- Ketidakleluasaan untuk tabel `tabel_guru1`
--
ALTER TABLE `tabel_guru1`
...
--
ALTER TABLE `tabel_kelas`
  ADD CONSTRAINT `FK_REFERENCE_1` FOREIGN KEY (`KODE_GURU`) REFERENCES `tabel_guru1` (`KODE_GURU`);
...
ALTER TABLE `tabel_user`
  ...
  ADD CONSTRAINT `FK_REFERENCE_31` FOREIGN KEY (`KODE_GURU_USER`) REFERENCES `tabel_guru1` (`KODE_GURU`);
