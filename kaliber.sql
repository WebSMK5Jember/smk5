...
--
-- Host: 127.0.0.1
-- Generation Time: 22 Des 2018 pada 02.12
...
INSERT INTO `tabel_guru` (`NIP`, `KODE_MAPEL`, `KODE_GURU`, `KODE_JABATAN`, `KODE_PIKET`, `NAMA_GURU`, `ALAMAT_GURU`, `JUMLAH_JAM`) VALUES
('19700317 199303 1 008', NULL, 'A01', NULL, NULL, 'Sofyan Hadi Purwanto, SE, MT', NULL, 24);
...
--
ALTER TABLE `tabel_admin`
  ADD CONSTRAINT `tabel_admin_ibfk_1` FOREIGN KEY (`KODE_JABATAN`) REFERENCES `tabel_jabatan` (`KODE_JABATAN`);
